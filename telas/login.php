                ...
                <div class="p-5">
                  ...
                  <form action="logar.php" method="POST" class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" name="usuario" placeholder="Digite seu usuário">
                    </div>
                    <div class="form-group">
                 ...
                 <br>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="../admin/login.php">Área Administrador</a>
                  </div>
                </div>
              </div>
            </div>
