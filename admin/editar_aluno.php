			...
			<div class="container-fluid"><br>
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h4 class="m-0 font-weight-bold text-primary">Editar cadastro de: <?php echo $linha['nome_completo'];?></h4>
					</div>
					<div class="card-body">
						<form method="POST" action="edita_aluno.php?idaluno=<?php echo $linha['idaluno'];?>">
						  <div class="form-row">
							...
							<div class="form-group col-md-2">
							  ...
							  <select id="status" class="form-control" name="status">
								<option selected><?php echo $linha['status'];?></option>
								<?php 
						  ...
						  <div class="form-row">
								...
								<div class="form-group col-md-2">
								  <label>CEP</label>
								  <input type="text" class="form-control cep-mask" id="cep" value="<?php echo $linha['cep'];?>" name="cep">
								</div>					
						  </div>
						  <div class="form-row">
						  ...
						  <div class="form-row">
							  <div class="form-group col-md-2">
								...
								<div class="form-group col-md-2">
								  <label>Senha</label>
								  <input type="password" class="form-control" id="senha" value="<?php echo $linha['senha'];?>" name="senha">
								</div>					
						  </div>
